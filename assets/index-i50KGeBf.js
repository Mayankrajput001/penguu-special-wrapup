...
const BookOpen = createLucideIcon("BookOpen", __iconNode$c);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const RotateCcw = createLucideIcon("RotateCcw", __iconNode$4);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
class SoundEffects {
  ...
  playFirework() {
    ...
    osc.frequency.exponentialRampToValueAtTime(600, now2 + 0.2);
    gain.gain.setValueAtTime(0.2, now2);
    gain.gain.exponentialRampToValueAtTime(0.01, now2 + 0.2);
    osc.connect(gain);
    gain.connect(this.ctx.destination);
    osc.start(now2);
    osc.stop(now2 + 0.2);
  ...
  playPartyHorn() {
    ...
    osc.frequency.linearRampToValueAtTime(450, now2 + 0.15);
    osc.frequency.linearRampToValueAtTime(400, now2 + 0.35);
    gain.gain.setValueAtTime(0.25, now2);
    gain.gain.exponentialRampToValueAtTime(1e-3, now2 + 0.4);
    osc.connect(gain);
    gain.connect(this.ctx.destination);
    osc.start(now2);
    osc.stop(now2 + 0.4);
  ...
  playFanfare() {
    ...
    notes.forEach((freq, i) => {
      ...
      gain.gain.setValueAtTime(0.2, now2 + i * 0.1);
      gain.gain.exponentialRampToValueAtTime(1e-3, now2 + i * 0.1 + 0.3);
      osc.connect(gain);
      gain.connect(this.ctx.destination);
      osc.start(now2 + i * 0.1);
      osc.stop(now2 + i * 0.1 + 0.3);
    });
  }
}
...
function FarewellNavbar({ currentPhase, isMuted, setIsMuted }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 px-3 sm:px-4 py-2.5 sm:py-3 bg-slate-950/85 backdrop-blur-md border-b border-rose-500/20 select-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto flex items-center justify-between gap-2 sm:gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-gradient-to-tr from-rose-500 via-pink-500 to-purple-600 flex items-center justify-center text-base sm:text-lg shadow-md", children: "🌙" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:block text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-extrabold text-xs sm:text-sm md:text-base bg-clip-text text-transparent bg-gradient-to-r from-rose-300 via-pink-200 to-purple-300 flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Penguu’s Birthday Wrap-Up" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 12, className: "text-pink-400 animate-spin" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] sm:text-[10px] text-pink-300/70 font-medium", children: "As Birthday Comes To An End 💖" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 sm:gap-1.5 bg-slate-900/90 p-1 rounded-full border border-pink-500/20 shrink-0", children: phases.map((p2) => {
      const isActive = currentPhase === p2.id;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `flex items-center gap-1 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-bold transition-all duration-300 pointer-events-none ${isActive ? "bg-gradient-to-r from-rose-500 to-pink-500 text-white shadow-lg shadow-rose-500/30 scale-105 border border-pink-300/30" : "text-slate-500 opacity-60"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs sm:text-sm", children: p2.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:inline", children: p2.label })
          ]
        },
        p2.id
      );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: `p-1.5 sm:p-2 rounded-full border transition-all ${isMuted ? "bg-slate-800/80 border-slate-700 text-slate-400" : "bg-rose-500/20 border-rose-500/40 text-pink-300 glow-pink"}`,
...
function Phase1Countdown({ onNextPhase }) {
  const createFreshTargetTime = () => {
    ...
    if (target.getTime() <= now2.getTime()) {
      target = new Date(now2.getFullYear(), now2.getMonth(), now2.getDate() + 1, 23, 59, 59);
    }
    return target;
  };
  const [targetTime] = reactExports.useState(createFreshTargetTime);
  ...
  reactExports.useEffect(() => {
    const updateTimer = () => {
      ...
      const diff = Math.max(0, target - now2);
      ...
      const elapsed = Math.min(totalDayMs, Math.max(0, now2 - startOfDay.getTime()));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-4 sm:py-6 px-3 sm:px-4 max-w-4xl mx-auto text-center min-h-[78vh] sm:min-h-[82vh] w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { size: 14, className: "text-pink-400 animate-pulse shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Step 1 of 3: Birthday End Countdown 🕯️" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl md:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-rose-300 via-pink-200 to-amber-200 mb-2 leading-tight", children: "As The Birthday Comes To An End... 🕯️✨" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm md:text-base text-pink-200/90 max-w-2xl mb-6 leading-relaxed", children: "The birthday hours are ticking away, but every smile, laugh, and memory from today will stay in our hearts forever! Here is our official countdown to the end of the birthday celebration. 💖" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 sm:gap-6 max-w-md mx-auto mb-6", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-pink-200 via-rose-300 to-purple-300 font-mono tracking-wider", children: String(item.value).padStart(2, "0") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-lg mx-auto space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-[11px] text-pink-200/80 font-medium", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Birthday Started 🎈" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                Math.round(progress2),
                "% Completed"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Birthday End 🌙" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-slate-900/90 rounded-full h-3 p-0.5 border border-pink-500/30 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
...
function Phase2Memories({ onNextPhase, onPrevPhase }) {
  ...
  const [memories, setMemories] = reactExports.useState(photoMemories);
  const [selectedPhotoIndex, setSelectedPhotoIndex] = reactExports.useState(null);
  const handleLikePhoto = (e, id2) => {
    e.stopPropagation();
    sounds.playSparkle();
    confetti({ particleCount: 35, spread: 55, origin: { y: 0.7 } });
    setMemories((prev) => prev.map((m2) => m2.id === id2 ? { ...m2, likes: m2.likes + 1 } : m2));
  };
  const handleOpenPhoto = (idx) => {
    sounds.playSparkle();
    setSelectedPhotoIndex(idx);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-4 sm:py-6 px-3 sm:px-4 max-w-5xl mx-auto text-center min-h-[78vh] sm:min-h-[82vh] w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: -10 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm md:text-base text-pink-200/90 max-w-2xl mb-8 leading-relaxed", children: "Tap on any photo card to open it in full view and read the sweet story written for it! 📸✨" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 w-full mb-8", children: memories.map((mem, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full rounded-3xl bg-slate-900/90 border-2 border-pink-400/40 p-3 shadow-2xl flex flex-col justify-between group-hover:border-pink-400/80 transition-all h-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full bg-slate-950/90 rounded-2xl overflow-hidden border border-white/10 flex items-center justify-center p-1.5 min-h-[260px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: mem.image,
                alt: mem.title,
                className: "w-full h-auto max-h-[380px] object-contain rounded-xl shadow-inner group-hover:scale-102 transition-transform duration-300"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3 px-2.5 py-0.5 rounded-full bg-slate-950/90 text-[10px] font-extrabold text-pink-300 border border-pink-500/40 backdrop-blur-sm shadow", children: mem.tag })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 text-left flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: "flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-rose-500/20 text-rose-300 hover:bg-rose-500/30 transition-colors font-bold border border-rose-500/30 text-xs shrink-0",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 12, className: "fill-rose-500 text-rose-500" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: mem.likes })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full py-2 rounded-xl bg-pink-500/20 hover:bg-pink-500/30 border border-pink-500/40 text-pink-200 text-xs font-bold flex items-center justify-center gap-1.5 transition-colors shadow-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 13, className: "text-pink-300" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Tap to Read Story 💌" })
            ] })
          ] })
        ] })
      },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: selectedPhotoIndex !== null && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-950/90 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full md:w-1/2 bg-slate-950 flex items-center justify-center p-3 min-h-[300px] sm:min-h-[420px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              ...
              className: "w-full h-auto max-h-[55vh] md:max-h-[75vh] object-contain rounded-2xl shadow-lg"
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-1/2 p-5 sm:p-7 flex flex-col justify-between bg-slate-900/95 border-t md:border-t-0 md:border-l border-pink-500/20 overflow-y-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-2.5 py-0.5 rounded-full bg-pink-500/20 text-pink-300 border border-pink-500/30 text-[10px] font-extrabold mb-3", children: memories[selectedPhotoIndex].tag }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg sm:text-xl font-extrabold text-pink-100 mb-1", children: memories[selectedPhotoIndex].title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-pink-300/70 font-semibold mb-4", children: memories[selectedPhotoIndex].subtitle }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-2xl bg-slate-950/80 border border-pink-400/30 mb-4 shadow-inner", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs sm:text-sm text-pink-100 leading-relaxed font-sans", children: [
                '"',
                memories[selectedPhotoIndex].text,
                '"'
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-gradient-to-r from-rose-500/10 to-pink-500/10 border border-rose-500/20 text-amber-200 text-xs italic font-medium", children: [
                "✨ ",
                memories[selectedPhotoIndex].quote
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 mt-4 border-t border-pink-500/20 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 14, className: "fill-rose-500 text-rose-500" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                      memories[selectedPhotoIndex].likes,
                      " Likes"
                    ] })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-pink-300/70 font-bold", children: [
                "Photo ",
...
function Phase3Letter({ onRestart, onPrevPhase }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-4 sm:py-6 px-3 sm:px-4 max-w-3xl mx-auto text-center min-h-[78vh] sm:min-h-[82vh] w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: -10 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl md:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-pink-300 via-rose-200 to-amber-200 mb-2", children: "A Post-Birthday Message For Penguu 💖" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm md:text-base text-pink-200/90 mb-6", children: isOpen ? "Here is my message written straight from the heart!" : "Tap on the wax-sealed envelope to open your post-birthday letter!" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 text-[10px] sm:text-xs font-bold text-rose-700 mt-2 tracking-wider uppercase", children: "For My Cute Penguuu 💖" }),
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between pb-3 sm:pb-4 mb-3 sm:mb-4 border-b border-pink-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-rose-600 font-bold text-sm sm:text-base md:text-lg", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "As Birthday Comes To An End... 🥹🎂❤️" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 sm:space-y-4 text-slate-800 font-sans leading-relaxed text-xs sm:text-sm md:text-base", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-rose-700", children: "Hey my cute Penguuu! 🫶🏻" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "As your birthday draws to a close today, I just wanted to leave you with a little message to remind you how deeply loved and cherished you truly are." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "p-3 sm:p-3.5 rounded-2xl bg-pink-100/60 border border-pink-300/40 text-rose-900 font-medium", children: "Thank you for letting me celebrate today with you, for your bright happy smile, and for being one of the most special, sweetest human beings in my entire life. 🥹❤️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The birthday date may be wrapping up tonight, but the happiness, laughter, and memories we created today will stay with us forever." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-pink-200/60", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-sm sm:text-base md:text-lg text-rose-600", children: "Here's to you, to us, and to another 365 days of magic! ✨" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-700 italic", children: "I will always be right here cheering for you, supporting you, and being your best friend forever. ♾️💖" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-pink-200 flex flex-col items-end", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] sm:text-xs text-slate-500 font-sans mt-0.5", children: "With all my love, always! ✨" })
            ] })
          ]
        },
        "letter"
      ...
      isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Replay Birthday Wrap-Up 🎈" })
          ]
        }
      )
    ] })
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen text-slate-100 relative flex flex-col justify-between select-none font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex items-center justify-center relative z-10 py-4 sm:py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "wait", children: [
      currentPhase === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
      ...
      currentPhase === 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, x: -30 },
          animate: { opacity: 1, x: 0 },
